...
UPDATEPATH=$BUILDPATH/RKTools/windows/AndroidTool/rockdev
...
_svn_server_pdir="${_svn_server_pdir:-https://192.168.19.238/svn/101PAD/ROM包/nd360/临时测试包}"  
...
_ftp_server_pdir_qa="${_ftp_server_pdir_qa:-192.168.160.4/nd360}"
...
# 编译u-boot
source ${JOBSCRIPTSPATH}/nd360/base/nd360_make_uboot.sh
# 编译kernel
