...
_svn_server_pdir="${_svn_server_pdir:-https://192.168.19.238/svn/101PAD/ROM包/联想/测试包/tb8704f}"
# _svn_server_pdir_qa="${_svn_server_pdir_qa:-https://192.168.160.4:8443/svn/101pad/待测试/ROM/nd3}" 	# QA的SVN上传地址，为 none 时，不上传
_svn_server_pdir_qa="${_svn_server_pdir_qa:-https://192.168.160.4:8443/svn/101pad/待测试/ROM/联想/tb8704f}"
# _ftp_server_pdir_qa="${_ftp_server_pdir_qa:-192.168.160.4/nd3}"  	# QA的FTP上传地址，为 none 时，不上传
_ftp_server_pdir_qa="${_ftp_server_pdir_qa:-192.168.160.4/联想/tb8704f}"
