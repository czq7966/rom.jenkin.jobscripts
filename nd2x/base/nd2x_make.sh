...
_svn_server_pdir="${_svn_server_pdir:-https://192.168.19.238/svn/101PAD/ROM包/nd2x/临时测试包}"
_svn_server_pdir_qa="${_svn_server_pdir_qa:-https://192.168.160.4:8443/svn/101pad/待测试/ROM/nd2x}"
_ftp_server_pdir_qa="${_ftp_server_pdir_qa:-192.168.160.4/nd2x}"
...
# 编译Android
source ${JOBSCRIPTSPATH}/nd2x/base/nd2x_make_android.sh
# 生成刷机包
source ${JOBSCRIPTSPATH}/nd2x/base/nd2x_make_android_update.sh
# 生成OTA包
source ${JOBSCRIPTSPATH}/nd2x/base/nd2x_make_android_ota.sh
# 生成OTA测试包
source ${JOBSCRIPTSPATH}/nd2x/base/nd2x_make_android_ota_test.sh
# 上传至部门内SVN
