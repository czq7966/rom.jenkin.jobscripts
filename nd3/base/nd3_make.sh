...
# 编译u-boot
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_uboot.sh
# 编译kernel
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_kernel.sh
# 编译Android
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_android.sh
# 生成刷机包
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_android_update.sh
# 生成OTA包
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_android_ota.sh
# 生成测试OTA包
source ${JOBSCRIPTSPATH}/nd3/base/nd3_make_android_ota_test.sh
# 上传至部门内SVN
